...
class App:
    ...
    def _draw_alarm_edit(self):
        ...
        self.display.text("{:02d}:{:02d}".format(self.alarm_edit_hour, self.alarm_edit_minute), 38, 20, 1)
        self.display.show()
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                frame += 1
                time.sleep(0.05 if self.alarm_until is not None else 0.2)
            except Exception as e:
                print("Loop fout:", e)
                time.sleep(0.5)
